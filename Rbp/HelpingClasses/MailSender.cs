    ...
    public class MailSender
    {
        ...
        public async Task<bool> SendForgotPasswordEmailAsync(string email, string id, string BaseUrl = "")
        {
            try
            {
                ...
                message.From.Add(new MailboxAddress("TraceyDawley", projectVariables.FromEmail));
                message.To.Add(new MailboxAddress("TraceyDawley", email));
                message.Subject = "TraceyDawley | Forgot Password";
